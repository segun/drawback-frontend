...
type AuthModuleViewProps = {
    ...
    setResetPasswordNewPassword: (value: string) => void;
    resetPasswordConfirmPassword: string;
    setResetPasswordConfirmPassword: (value: string) => void;
    handleResetPassword: (event: React.FormEvent<HTMLFormElement>) => Promise<void>;
    resetPasswordResultStatus: "success" | "error" | null;
    resetPasswordResultMessage: string | null;
    resetPasswordResultEmail: string | null;
    handleResetPasswordResultGoToLogin: () => void;
...
export function AuthModuleView({
    ...
    handleResetPassword,
    resetPasswordResultStatus,
    resetPasswordResultMessage,
    resetPasswordResultEmail,
    handleResetPasswordResultGoToLogin,
    searchQuery,
    setSearchQuery,
    searchResults,
    isSearching,
    ...
    const [confirmBlockUser, setConfirmBlockUser] = useState<{
        id: string;
        displayName: string;
    } | null>(null);
    const [confirmUnblockUser, setConfirmUnblockUser] = useState<{
        id: string;
        displayName: string;
    } | null>(null);
    ...
    const presetColors = useMemo(() => ["#e11d48", "#fb7185", "#f59e0b", "#10b981", "#0ea5e9"], []);
    ...
    const newRequestIsAlreadyConnected =
        ...
        filteredRecentChats.some(
            (chat) => getOtherUser(chat).displayName.toLowerCase() === newRequestTarget,
        );
    ...
    return (
        ...
        >
            <header
                className={`${accessToken ? "border-b border-rose-300 bg-rose-200/80" : "mb-6 border-b border-rose-300 bg-rose-200/80"}`}
            >
                <nav
                    className={`mx-auto flex w-full items-center justify-between ${accessToken ? "max-w-screen-2xl px-1 py-2" : "max-w-xl px-4 py-3"}`}
                >
                    <img
            ...
            >
                ...
                >
                    {!accessToken && (
                        <>
                            <p className="mb-4 text-sm text-rose-700">
                                Register with email, password, and display name. Login is allowed
                                only after email confirmation.
                            </p>
                        </>
                    )}
                        ...
                        <div className="mb-4 grid grid-cols-2 gap-2">
                            <button
                                ...
                                className={`rounded-md border px-4 py-2 text-sm font-medium ${
                                    tab === "register"
                                        ? "border-rose-700 bg-rose-700 text-rose-100"
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    {displayNameAvailability === "invalid" && (
                                        <p className="flex items-center gap-1.5 text-xs font-medium text-red-700">
                                            ...
                                            Must start with @ followed by 3–29 letters, numbers or
                                            underscores
                                        </p>
                                    )}
                    ...
                    {!accessToken && showForgotPasswordModal && (
                        <div
                        ...
                        <form className="flex flex-col gap-3" onSubmit={handleResetPassword}>
                            ...
                            <label className="flex flex-col gap-1 text-sm">
                                ...
                                <input
                                    ...
                                    maxLength={PASSWORD_MAX}
                                    onChange={(event) =>
                                        setResetPasswordConfirmPassword(event.target.value)
                                    }
                    ...
                    {!accessToken && resetPasswordResultStatus && (
                        <div className="flex flex-col gap-4">
                            {resetPasswordResultStatus === "success" ? (
                                <>
                                    ...
                                    <button
                                        type="button"
                                        onClick={handleResetPasswordResultGoToLogin}
                    ...
                    {accessToken && (
                        <div className="relative mt-2 grid h-[calc(100%-0.5rem)] w-full gap-4 overflow-hidden lg:grid-cols-[20rem_minmax(0,1fr)] landscape:max-lg:h-auto landscape:max-lg:overflow-visible">
                                ...
                                <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-3">
                                    {searchQuery.trim() && (
                                        <section>
                                            ...
                                            {isSearching && (
                                                <p className="text-xs text-rose-500">Searching…</p>
                                            )}
                                            {!isSearching && (
                                                <ul className="flex flex-col gap-2">
                                                    {searchResults.map((user) => {
                                                        const isConnected = connectedUserIds.has(
                                                            user.id,
                                                        );
                                                        const isPending =
                                                            pendingOutgoingUserIds.has(user.id);
                                    ...
                                    <section>
                                        ...
                                        <ul className="flex flex-col gap-2">
                                            {filteredRecentChats.map((chat) => {
                                                ...
                                                const isPeerWaiting = waitingPeerRequestIds.has(
                                                    chat.id,
                                                );
                                                return (
                                                    <li key={chat.id}>
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={
                                                            ...
                                                            newRequestDisplayName.trim().length <
                                                                2 ||
                                                            newRequestIsSelf ||
                                        ...
                                        <ul className="flex flex-col gap-2">
                                            {filteredChatRequests.map((request) => {
                                                ...
                                                return (
                                                    <li
                                                        key={request.id}
                                                        className="rounded-md border border-rose-300 bg-rose-100 p-2"
                                                    >
                                                            ...
                                                            {isIncomingPending && (
                                                                <>
                                                                    <button
                                                                        ...
                                                                        disabled={
                                                                            activeActionKey ===
                                                                            `request-status:${request.id}:ACCEPTED`
                                                                        }
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        disabled={
                                                                            activeActionKey ===
                                                                            `request-status:${request.id}:REJECTED`
                                                                        }
                            ...
                            <section className="min-w-0 h-full min-h-0 overflow-hidden rounded-md border border-rose-300 bg-rose-200 p-4 landscape:max-lg:h-auto landscape:max-lg:overflow-visible">
                                {isDashboardLoading && (
                                    <p className="text-sm text-rose-700">Loading your workspace…</p>
                                )}
                                ...
                                {!isDashboardLoading && profile && centerView === "profile" && (
                                    ...
                                    >
                                        ...
                                        <label
                                            className={`flex flex-row items-center gap-2 text-sm ${profileMode === "PUBLIC" ? "cursor-not-allowed opacity-60" : "cursor-pointer"}`}
                                        >
                                            <input
                                                type="checkbox"
                                                ...
                                                onChange={(event) =>
                                                    setAppearInSearches(event.target.checked)
                                                }
                                            ...
                                            <span>
                                                ...
                                                {profileMode === "PUBLIC" && (
                                                    <span className="ml-1 text-xs text-rose-500">
                                                        (A public profile always appears in
                                                        searches)
                                                    </span>
                                                )}
                                            </span>
                                    ...
                                    <div className="mx-auto flex h-full min-h-0 w-full flex-col items-center gap-4 overflow-hidden landscape:max-lg:h-auto landscape:max-lg:overflow-visible">
                                        {!selectedChat && (
                                            <div className="flex min-h-80 w-full items-center justify-center rounded-md border border-rose-300 bg-rose-100 p-6 text-center">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-rose-700">
                                                        Select a recent chat from the left to open
                                                        your chat canvases.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        {selectedChat && (
                                            <div className="flex h-full min-h-0 w-full flex-col overflow-hidden landscape:max-lg:h-auto landscape:max-lg:overflow-visible">
                                                {joinedChatRequestId === selectedChat.id &&
                                                    !peerPresent && (
                                                        <div className="mb-3">
                                                ...
                                                <div className="relative min-h-0 flex-1 flex flex-col overflow-hidden landscape:max-lg:flex-none landscape:max-lg:overflow-visible">
                                                    <div className="grid min-h-0 flex-1 gap-3 overflow-hidden grid-rows-2 landscape:max-lg:flex-none landscape:max-lg:overflow-visible landscape:max-lg:grid-rows-none landscape:max-lg:min-h-[500px]">
                                                        <div className="relative flex min-h-0 flex-col rounded-md border border-rose-300 bg-rose-100 p-3">
                                                            <canvas
                                                                ref={remoteCanvasRef}
                                                                className="h-full min-h-0 w-full rounded-md border border-rose-300 bg-rose-50 cursor-not-allowed landscape:max-lg:min-h-[200px]"
                                                            />
                                                        ...
                                                        <div className="flex min-h-0 flex-col rounded-md border border-rose-300 bg-rose-100 p-3">
                                                            <div className="mb-2 flex flex-wrap items-center gap-1">
                                                                ...
                                                                {!savedRequestIdSet.has(
                                                                    selectedChat.id,
                                                                ) && (
                                                                    <button
                                                                        type="button"
                                                                        onClick={() =>
                                                                            void saveAcceptedChat(
                                                                                selectedChat.id,
                                                                            )
                                                                        }
                                                                        disabled={
                                                                            activeActionKey ===
                                                                            `save-chat:${selectedChat.id}`
                                                                        }
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div className="mb-2">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span
                                                                                            className={`transition-transform ${brushAccordionOpen ? "rotate-180" : ""}`}
                                                                                        >
                                                                                            ▼
                                                                                        </span>
                                                                                    </button>
                                                                                ...
                                                                                <div className="mb-2">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span
                                                                                            className={`transition-transform ${strokeAccordionOpen ? "rotate-180" : ""}`}
                                                                                        >
                                                                                            ▼
                                                                                        </span>
                                                                                    </button>
                                                                                    {strokeAccordionOpen && (
                                                                                        <div className="mt-2 flex items-center gap-2">
                                                                                            ...
                                                                                            />
                                                                                            <span className="w-6 text-right text-xs font-semibold text-rose-700">
                                                                                                {
                                                                                                    drawWidth
                                                                                                }
                                                                                            </span>
                                                                                ...
                                                                                <div className="mb-2">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span
                                                                                            className={`transition-transform ${eraserAccordionOpen ? "rotate-180" : ""}`}
                                                                                        >
                                                                                            ▼
                                                                                        </span>
                                                                                    </button>
                                                                                ...
                                                                                <div className="mb-2">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span
                                                                                            className={`transition-transform ${colorAccordionOpen ? "rotate-180" : ""}`}
                                                                                        >
                                                                                            ▼
                                                                                        </span>
                                                                                    </button>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span
                                                                                            className={`transition-transform ${customColorAccordionOpen ? "rotate-180" : ""}`}
                                                                                        >
                                                                                            ▼
                                                                                        </span>
                                                                                    </button>
            ...
            {confirmUnblockUser && (
                ...
                >
                    <div className="w-full max-w-sm rounded-xl border border-rose-300 bg-white p-6 shadow-xl">
                        <h2
                            id="confirm-unblock-title"
                            className="mb-3 text-base font-semibold text-rose-800"
                        >
                            Unblock User
                        </h2>
